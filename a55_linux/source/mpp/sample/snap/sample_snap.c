...
static td_s32 sample_snap_sys_init(ot_vi_vpss_mode_type mode_type, ot_vi_aiisp_mode aiisp_mode,
    sample_sns_type sns_type)
{
    ...
    td_u32 supplement_config = OT_VB_SUPPLEMENT_BNR_MOT_MASK | OT_VB_SUPPLEMENT_JPEG_MASK;
...
static td_void sample_snap_usage(const char *prg_name)
{
