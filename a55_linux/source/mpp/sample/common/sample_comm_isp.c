...
static ot_isp_pub_attr g_isp_pub_attr_imx678_mipi_8m_30fps = {
    {0, 0, 3840, 2160},
    {3840, 2160},
    30,
    OT_ISP_BAYER_RGGB,
...
static ot_isp_pub_attr g_isp_pub_attr_imx586_mipi_48m_5fps = {
    {0, 0, 8000, 6000},
    {8000, 6000},
    5,
    OT_ISP_BAYER_RGGB,
...
static ot_isp_pub_attr g_isp_pub_attr_imx307_mipi_2m_30fps = {
    {0, 0, 1920, 1080},
    {1920, 1080},
    30,
    OT_ISP_BAYER_RGGB,
...
static ot_isp_pub_attr g_isp_pub_attr_imx415_mipi_8m_30fps = {
    {0, 3840, 2160},
    {1920, 2160},
    30,
    OT_ISP_BAYER_RGGB,
...
static ot_isp_pub_attr g_isp_pub_attr_gc2053_mipi_2m_30fps = {
    {0, 0, 1920, 1080},
    {1920, 1080},
    30,
    OT_ISP_BAYER_RGGB,
...
static ot_isp_pub_attr g_isp_pub_attr_imx482_mipi_2m_30fps = {
    {0, 0, 1920, 1080},
    {1920, 1080},
    30,
    OT_ISP_BAYER_RGGB,
...
td_s32 sample_comm_isp_get_pub_attr_by_sns(sample_sns_type sns_type, ot_isp_pub_attr *pub_attr)
{
    switch (sns_type) {
		...
		case SONY_IMX482_MIPI_2M_30FPS_12BIT:
            (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_imx482_mipi_2m_30fps, sizeof(ot_isp_pub_attr));
            break;
		case SONY_IMX585_MIPI_8M_30FPS_12BIT:
		case SONY_IMX678_MIPI_8M_30FPS_12BIT:
            (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_imx678_mipi_8m_30fps, sizeof(ot_isp_pub_attr));
            break;
		case SONY_IMX586_MIPI_48M_30FPS_12BIT:
            (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_imx586_mipi_48m_5fps, sizeof(ot_isp_pub_attr));
            break;
		case SONY_IMX307_MIPI_2M_30FPS_12BIT:
		case SONY_IMX662_MIPI_2M_30FPS_12BIT:
		case SONY_IMX307_2L_MIPI_2M_30FPS_12BIT:
            (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_imx307_mipi_2m_30fps, sizeof(ot_isp_pub_attr));
            break;
		case SONY_IMX415_2L_MIPI_8M_30FPS_12BIT:
			(td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_imx415_mipi_8m_30fps, sizeof(ot_isp_pub_attr));
            break;
		case GALAXYCORE_GC2053_MIPI_2M_30FPS_10BIT:
            (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_gc2053_mipi_2m_30fps, sizeof(ot_isp_pub_attr));
            break;
        default:
            (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_os08a20_mipi_8m_30fps, sizeof(ot_isp_pub_attr));
...
ot_isp_sns_obj *sample_comm_isp_get_sns_obj(sample_sns_type sns_type)
{
    switch (sns_type) {
		...
		case SONY_IMX678_MIPI_8M_30FPS_12BIT:
            return &g_sns_imx678_obj;
		case SONY_IMX585_MIPI_8M_30FPS_12BIT:
			return &g_sns_imx585_obj;
		case SONY_IMX586_MIPI_48M_30FPS_12BIT:
			return &g_sns_imx586_obj;
		case SONY_IMX307_MIPI_2M_30FPS_12BIT:
            return &g_sns_imx307_obj;
		case SONY_IMX662_MIPI_2M_30FPS_12BIT:
			return &g_sns_imx662_obj;
		case SONY_IMX307_2L_MIPI_2M_30FPS_12BIT:
			return &g_sns_imx307_2l_obj;
		case SONY_IMX415_2L_MIPI_8M_30FPS_12BIT:
			return &g_sns_imx415_2l_obj;
		case GALAXYCORE_GC2053_MIPI_2M_30FPS_10BIT:
            return &g_sns_gc2053_obj;
        case GST_412C_SLAVE_THERMO_T3_384_288_30FPS_14BIT:
