...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx586_12bit_48m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 8000, 6000},
    .mipi_attr = {
        DATA_TYPE_RAW_12BIT,
        OT_MIPI_WDR_MODE_NONE,
        {0, 1, 2, 3, -1, -1, -1, -1}
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx586_12bit_48m_nowdr_dev2_attr = {
    .devno = 2,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, 8000, 6000},
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx307_12bit_2m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
...
static combo_dev_attr_t g_mipi_2lane_chn0_sensor_gc2053_10bit_2m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx307_12bit_2m_nowdr_dev2_attr = {
    .devno = 2, /* dev2 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_2lane_chn0_sensor_gc2053_10bit_2m_nowdr_dev2_attr = {
    .devno = 2, /* dev2 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx482_12bit_2m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx482_12bit_2m_nowdr_dev2_attr = {
    .devno = 2, /* dev2 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_2lane_chn0_sensor_imx307_12bit_2m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_2lane_chn0_sensor_imx307_12bit_2m_nowdr_dev2_attr = {
    .devno = 2,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_1920, HEIGHT_1080},
...
static combo_dev_attr_t g_mipi_2lane_chn0_sensor_imx415_12bit_8m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_3840, HEIGHT_2160},
...
static combo_dev_attr_t g_mipi_2lane_chn0_sensor_imx415_12bit_8m_nowdr_dev2_attr = {
    .devno = 2,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_3840, HEIGHT_2160},
...
static td_void sample_comm_vi_get_mipi_attr(sample_sns_type sns_type, combo_dev_attr_t *combo_attr)
{
    ...
    switch (sns_type) {
		...
		case SONY_IMX482_MIPI_2M_30FPS_12BIT:
            ob_height = 20;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_imx482_12bit_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
		...
		case SONY_IMX586_MIPI_48M_30FPS_12BIT:
            ob_height = 0;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_imx586_12bit_48m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
		case SONY_IMX307_MIPI_2M_30FPS_12BIT:
		case SONY_IMX662_MIPI_2M_30FPS_12BIT:
            ob_height = 0;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_imx307_12bit_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
		case SONY_IMX307_2L_MIPI_2M_30FPS_12BIT:
            ob_height = 0;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_2lane_chn0_sensor_imx307_12bit_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
		case SONY_IMX415_2L_MIPI_8M_30FPS_12BIT:
            ob_height = 0;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_2lane_chn0_sensor_imx415_12bit_8m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
		case GALAXYCORE_GC2053_MIPI_2M_30FPS_10BIT:
            ob_height = 0;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_2lane_chn0_sensor_gc2053_10bit_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
        default:
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_os08a20_12bit_8m_nowdr_attr, sizeof(combo_dev_attr_t));
    ...
    switch (sns_type) {
		...
		case SONY_IMX586_MIPI_48M_30FPS_12BIT:
            ...
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn0_sensor_imx586_12bit_48m_nowdr_dev2_attr, sizeof(combo_dev_attr_t));
            }
            break;
		case SONY_IMX482_MIPI_2M_30FPS_12BIT:
            ob_height = 20;
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn0_sensor_imx482_12bit_2m_nowdr_dev2_attr, sizeof(combo_dev_attr_t));
            }
            break;
		case SONY_IMX307_MIPI_2M_30FPS_12BIT:
		case SONY_IMX662_MIPI_2M_30FPS_12BIT:
            ...
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn0_sensor_imx307_12bit_2m_nowdr_dev2_attr, sizeof(combo_dev_attr_t));
            }
            break;
		case SONY_IMX307_2L_MIPI_2M_30FPS_12BIT:
            ob_height = 0;
            if (vi_dev == 0) {
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn0_sensor_imx307_12bit_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            } else if (vi_dev == 1) { /* dev2 */
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn0_sensor_imx307_12bit_2m_nowdr_dev2_attr, sizeof(combo_dev_attr_t));
            }
            break;
		case SONY_IMX415_2L_MIPI_8M_30FPS_12BIT:
            ob_height = 0;
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn0_sensor_imx415_12bit_8m_nowdr_dev2_attr, sizeof(combo_dev_attr_t));
            }
            break;
		case GALAXYCORE_GC2053_MIPI_2M_30FPS_10BIT:
            ob_height = 0;
            if (vi_dev == 0) {
                ...
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_2lane_chn0_sensor_gc2053_10bit_2m_nowdr_dev2_attr, sizeof(combo_dev_attr_t));
            }
            break;
        case SC850SL_MIPI_8M_30FPS_12BIT:
            ob_height = OB_HEIGHT_END;
...
static td_void sample_comm_vi_get_default_grp_info(sample_sns_type sns_type, sample_vi_grp_info *grp_info)
{
	...
	grp_info->fusion_grp_attr[0].pipe_reverse = 0;
                                             ...
                                             sample_vi_pipe_info pipe_info[])
{
    ...
    for (i = 0; i < bind_pipe->pipe_num; i++) {
        ...
        pipe_info[i].nr_attr.compress_mode = OT_COMPRESS_MODE_NONE;
...
static td_s32 sample_comm_vi_set_grp_info(const sample_vi_grp_info *grp_info)
{
    ...
    for (i = 0; i < grp_info->grp_num; i++) {
		printf("grp_info->fusion_grp[i]=%d\n",grp_info->fusion_grp[i]);
		printf("grp_info->fusion_grp_attr[i]..pipe_reverse=%d\n",grp_info->fusion_grp_attr[i].pipe_reverse);
		printf("grp_info->fusion_grp_attr[i]..wdr_mode=%d\n",grp_info->fusion_grp_attr[i].wdr_mode);
		printf("grp_info->fusion_grp_attr[i]..cache_line=%d\n",grp_info->fusion_grp_attr[i].cache_line);
    ...
    td_bool is_master_pipe)
{
	...
	printf("pipe_info->pipe_attr.compress_mode=%d\n",pipe_info->pipe_attr.compress_mode);
