...
static td_s32 scene_load_static_thermo(const td_char *module, ot_scene_static_thermo *curve_attr)
{
    ot_scenecomm_check_pointer_return(curve_attr, TD_FAILURE);
    td_s32 ret;
    td_s32 get_value;

    scene_load_int(module, "static_thermo:clip", curve_attr->clip, td_u16);
    scene_load_int(module, "static_thermo:fusion_ratio", curve_attr->fusion_ratio, td_u8);
    scene_load_array(module, "static_thermo:fusion_curve", curve_attr->fusion_curve_value,
        OT_ISP_GAMMA_NODE_NUM, td_u16);
    return TD_SUCCESS;
}
...
static td_s32 scene_load_dynamic_aidrc(const td_char *module, ot_scene_module_state *module_state,
...
static td_s32 scene_load_scene_param(const td_char *module, ot_scene_pipe_param *scene_param)
{
    ...
    scene_load_module(scene_load_static_thermo, module, &scene_param->static_thermo);
